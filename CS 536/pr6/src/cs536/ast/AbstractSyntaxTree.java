...
public class AbstractSyntaxTree
{
    ...
    */
	...
	public void setRegs(Regs r)
	{
		currentReg = r;
	}
	public FpRegs getFpRegs()
	{
		return currentFpReg;
	}
	public void setFpRegs(FpRegs r)
	{
		currentFpReg = r;
	}
    ...
    public static class FunctionCallExp extends Expression
    {
        ...
        public Object accept(AstVisitor v) {
            ...
            while(it.hasNext()) {
                ...
                // MWA - special case for formal args we have to free them now
                // since they wont get copied to stack until all of them have been
                // evaluated
                if(v instanceof CodeGenerator)
                    ((CodeGenerator)v).freeIntReg(ex.getRegs());
            }
