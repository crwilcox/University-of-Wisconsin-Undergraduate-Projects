...
*/
	...
	String initResult)
	{
		...
		if(initResult == null){
			return typeResult + " " + localVar.getName() + ";";
		}
		else{
			return typeResult + " " + localVar.getName() + " = " + initResult + ";";
		}
	}
	...
	public String visitBooleanLit(BooleanLit booleanLit) {
		return Boolean.toString(booleanLit.getValue());
	}
	...
	public String visitIntLit(IntLit intLit) {
		return Long.toString(intLit.getValue());
	}

	public String visitDoubleLit(DoubleLit doubleLit) {
		return Double.toString(doubleLit.getValue());
	}
	...
	public String visitBooleanType(BooleanType boolType) {
		return "bool";
	}

	public String visitIntType(IntType intType) {
		return "int";
	}


	public String visitDoubleType(DoubleType doubleType) {
		return "double";
	}
	...
	public String visitArrayType(ArrayType arrayType, String innerResult)
	{
